...
h2. 0.9.7 Repackaging - 2011-07-26

Release 0.9.7 is a repackaging of the 0.9.6 release due to problems with Rubygems.

h2. 0.9.6 Patch Release - 2011-07-26

Release 0.9.6 is a minor bugfix release.

Full notes:

* Riak::SessionStore (Rack-based) now works with Rails 2.3.x. [Mathias Meyer]
* Added Travis CI support. [Myron Marston]
* Pinned beefcake dependency to 0.3.2 to prevent bug around booleans.
